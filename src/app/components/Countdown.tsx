...
export default function Countdown() {
  ...
  return (
    <section id="countdown" className="pt-10 pb-6 text-center relative">
      ...
      >
        <h2
          className="text-lg sm:text-2xl font-semibold mb-2 text-[#4a3f35] tracking-wider"
          style={playfairStyle}
        >
          Menuju Hari Bahagia
        </h2>
      ...
      {finished ? (
        ...
        <div className="flex justify-center gap-2 sm:gap-3 md:gap-4">
          {Object.entries(time).map(([key, value], index) => (
            ...
            >
              <div
                className="bg-white/40 backdrop-blur-md border-2 border-[#d4af37]/50 rounded-2xl w-16 sm:w-20 md:w-24 py-3 sm:py-4 md:py-5 shadow-xl group-hover:shadow-2xl transition-all duration-300 group-hover:scale-105
"
              >
