  ...
  return (
    <div className="flex min-h-screen w-full justify-center items-center relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0">
        ...
        />
        <div
          className="absolute inset-0 bg-gradient-to-br from-[#8b9370]/30 via-black/10 to-[#6b7353]/40 animate-pulse"
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center p-6 gap-10">
          ...
          <div className="text-center space-y-4 animate-fade-in">
            ...
            <div className="flex items-center justify-center gap-4 mb-5">
              ...
              <svg
                className="w-7 h-7 text-[#d4af37] drop-shadow-lg"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
            ...
            <p className="text-xl md:text-4xl font-serif italic tracking-wider text-[#6b7353] drop-shadow-2xl">
              Undangan Pernikahan
            </p>
          ...
          <div className="relative w-full max-w-xs">
            ...
            >
              {/* Glow Effect */}
              <div
                className={`absolute -inset-4 bg-gradient-to-b from-[#d4af37]/20 via-white/10 to-[#8b9370]/20 rounded-3xl blur-2xl transition-all duration-700 ${
              ...
              <div className="relative bg-gradient-to-br from-white/40 via-white/25 to-[#8b9370]/30 backdrop-blur-xl rounded-2xl overflow-hidden shadow-2xl border border-white/30">
                    ...
                    >
                      <defs>
                        ...
                        >
                          <stop
                            offset="0%"
                            style={{ stopColor: "#8b9370", stopOpacity: 0.6 }}
                          />
                          <stop
                            offset="50%"
                            style={{ stopColor: "#6b7353", stopOpacity: 0.7 }}
                          />
                          <stop
                            offset="100%"
                            style={{ stopColor: "#5a6147", stopOpacity: 0.8 }}
                          />
                        </linearGradient>
                        <filter id="shadow">
                          <feDropShadow
                    ...
                    {!isOpen && (
                      ...
                      >
                        <div className="relative w-16 h-16 bg-gradient-to-br from-[#d4af37] via-amber-600 to-amber-800 rounded-full shadow-2xl flex items-center justify-center border-4 border-white/20">
                          ...
                          {/* Animated ring */}
                          <div
                            className="absolute inset-0 rounded-full border-2 border-yellow-300/40 animate-ping"
                            style={{ animationDuration: "2.5s" }}
                          />
                ...
                <div className="relative bg-gradient-to-b from-white/90 via-white/85 to-gray-50/90 backdrop-blur-md pt-8 pb-12 px-6 text-center rounded-b-2xl shadow-inner border-t border-white/40">
                  ...
                  <div className="flex items-center justify-center">
                    <div className="w-56 h-16 mx-auto overflow-hidden">
                      <img
                  ...
                  >
                    ...
                    <svg
                      className={`w-6 h-6 relative z-10 transition-transform duration-500 ${
                        isHovering ? "rotate-[-10deg] scale-110" : ""
                      }`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
