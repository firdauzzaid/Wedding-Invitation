      ...
      <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-[#fdfcfb] via-[#f9f7f1] to-[#f5f1e8]">
        ...
        <div className="min-h-screen pt-8 pb-20 px-4 flex justify-center items-center">
          ...
          <motion.div
            ...
            className="relative rounded-[2rem] p-8 md:p-12 shadow-2xl w-full max-w-2xl
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="relative mx-auto mt-8 bg-gradient-to-r from-[#d4af37] via-[#e6c85c] to-[#d4af37]
                         text-[#1f2937] px-10 py-4 rounded-full font-semibold shadow-xl text-base
                         transition-all duration-300 overflow-hidden group"
            >
              <span className="relative z-10 tracking-wider">Lihat Undangan Lengkap</span>
              <motion.div
